; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30152.0 
	...
	TITLE	C:\dev\String\bin\intermediates\Win32\Debug\Main.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_03KCABIPMJ@666@				; `string'
PUBLIC	??_C@_02POGCAHMO@th@				; `string'
PUBLIC	??_C@_0L@IICCBDHO@?J?G?$LH?q?$LA?$PM?$LK?$KM?$KD?$LK@ ; `string'
PUBLIC	??_C@_0N@NKAGKFMH@PrintString?3@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0N@NKAGKFMH@PrintString?3@
CONST	SEGMENT
??_C@_0N@NKAGKFMH@PrintString?3@ DB 'PrintString:', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@IICCBDHO@?J?G?$LH?q?$LA?$PM?$LK?$KM?$KD?$LK@
CONST	SEGMENT
??_C@_0L@IICCBDHO@?J?G?$LH?q?$LA?$PM?$LK?$KM?$KD?$LK@ DB 0caH, 0c7H, 0b7H
	DB	0f1H, 0b0H, 0fcH, 0baH, 0acH, 0a3H, 0baH, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_02POGCAHMO@th@
CONST	SEGMENT
??_C@_02POGCAHMO@th@ DB 'th', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_03KCABIPMJ@666@
CONST	SEGMENT
??_C@_03KCABIPMJ@666@ DB '666', 00H			; `string'
CONST	ENDS
...
; 617  :     for (auto _Match_try = _Haystack + _Start_at;; ++_Match_try) {
	...
	mov	DWORD PTR __Match_try$1[ebp], eax
	jmp	SHORT $LN4@Traits_fin
$LN2@Traits_fin:
	mov	eax, DWORD PTR __Match_try$1[ebp]
	add	eax, 1
	mov	DWORD PTR __Match_try$1[ebp], eax
$LN4@Traits_fin:
...
; 618  :         _Match_try = _Traits::find(_Match_try, static_cast<size_t>(_Possible_matches_end - _Match_try), *_Needle);
	...
	sub	ecx, DWORD PTR __Match_try$1[ebp]
	push	ecx
	mov	edx, DWORD PTR __Match_try$1[ebp]
	push	edx
...
; 619  :         if (!_Match_try) { // didn't find first character; report failure
	...
	cmp	DWORD PTR __Match_try$1[ebp], 0
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\dev\String\String\src\Main.cpp
;	COMDAT _main
_TEXT	SEGMENT
tv151 = -304						; size = 4
_contains$ = -101					; size = 1
_S$ = -92						; size = 4
_s$ = -80						; size = 6
_name2$ = -64						; size = 6
_name$ = -48						; size = 28
...
; 11   : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __08152DC0_Main@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 12   : 	//char* name = "Ethan";	
; 13   : 	//报错：C++错误：“const char *“ 类型的值不能用于初始化 “char *“ 类型的实体
; 14   : 	//在VS2019版本中使用这种char*的表达方式会造成程序崩溃，所以VS2019对其进行了控件管理。解决方法：先将字符使用字符数组进行存储，再使用指针
; 15   : 	//char Name[] = "Ethan";	
; 16   : 	//char* name = Name;
; 17   : 	 
; 18   : 	std::string name = "Ethan";
...
; 21   : 	char name2[6] = { 'E','t','h','a','n',0};

	mov	BYTE PTR _name2$[ebp], 69		; 00000045H
	mov	BYTE PTR _name2$[ebp+1], 116		; 00000074H
	mov	BYTE PTR _name2$[ebp+2], 104		; 00000068H
	mov	BYTE PTR _name2$[ebp+3], 97		; 00000061H
	mov	BYTE PTR _name2$[ebp+4], 110		; 0000006eH
	mov	BYTE PTR _name2$[ebp+5], 0
...
; 24   : 	std::cout << name.size() << std::endl;
...
; 28   : 	name += "666";
	...
	push	OFFSET ??_C@_03KCABIPMJ@666@
	lea	ecx, DWORD PTR _name$[ebp]
...
; 33   : 	
; 34   : 	//char* - 输出字符串长度\
; 35   : 	//char *是一个指针类型,用于表示一个指向字符数组开头的指针,而char[]是一个字符数组类型,用于表示一个字符数组
; 36   : 	char s[] = "Ethan";	

	mov	eax, DWORD PTR ??_C@_05FBADLLFO@Ethan@
	mov	DWORD PTR _s$[ebp], eax
	mov	cx, WORD PTR ??_C@_05FBADLLFO@Ethan@+4
	mov	WORD PTR _s$[ebp+4], cx
...
; 39   : 
; 40   : 	//字符串匹配 
; 41   : 	bool contains = name.find("th") != std::string::npos;

	push	0
	push	OFFSET ??_C@_02POGCAHMO@th@
	lea	ecx, DWORD PTR _name$[ebp]
...
; 42   : 	std::cout << "是否包含："  << contains << std::endl;
	...
	push	eax
	push	OFFSET ??_C@_0L@IICCBDHO@?J?G?$LH?q?$LA?$PM?$LK?$KM?$KD?$LK@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 43   : 
; 44   : 
; 45   : 	std::cout << "PrintString:" << std::endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0N@NKAGKFMH@PrintString?3@
...
; 3805 :     _NODISCARD _CONSTEXPR20_CONTAINER reference operator[](const size_type _Off) noexcept /* strengthened */ {
...
; 3806 : #if _CONTAINER_DEBUG_LEVEL > 0
; 3807 :         _STL_VERIFY(_Off <= _Mypair._Myval2._Mysize, "string subscript out of range");
...
; 3808 : #endif // _CONTAINER_DEBUG_LEVEL > 0
...
; 3080 :     _CONSTEXPR20_CONTAINER basic_string& operator+=(_In_z_ const _Elem* const _Ptr) { // append [_Ptr, <null>)
...
; 409  :         const _Elem& _Ch) noexcept /* strengthened */ {
...
; 379  :         _In_reads_(_Count) const _Elem* const _First2, const size_t _Count) noexcept /* strengthened */ {
...
; 380  :         // compare [_First1, _First1 + _Count) with [_First2, ...)
; 381  : #if _HAS_CXX17
